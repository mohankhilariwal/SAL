# ADR-105: Use stage-specific guardrail policy enforcement points rather than one universal filter
...
Place guardrails at input, context, retrieval, planning, tool execution/result, output, state, memory, runtime and human review. Preserve existing component ownership and make the concrete receiver responsible for enforcement.
