# ADR-106: Use deterministic-first guardrails; model-assisted controls are advisory only
...
Critical authority, tenant isolation, schemas, state ownership, tool gateway, approval and production-gate controls are deterministic. Model-assisted classifiers may add quarantine/review signals but cannot allow, authorize, approve or override a deterministic denial.
