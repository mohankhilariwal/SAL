# ADR-109: Permit exceptions only for explicitly soft controls with scope, expiry and compensating controls
...
Hard and non-overrideable controls have no exception path. Soft exceptions require two independent humans, exclude the requester, bind tenant/case/operation/control IDs, expire within 30 days and record compensating controls.
