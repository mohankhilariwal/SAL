# ADR-111: Extend CMP-001..011 responsibilities without adding a new top-level runtime authority owner
...
Guardrail PEPs and policy lifecycle are allocated to the existing accepted components. CP-001 is a bounded governance profile, not a new agent, tool gateway, authority issuer, route owner or protected-state owner.
