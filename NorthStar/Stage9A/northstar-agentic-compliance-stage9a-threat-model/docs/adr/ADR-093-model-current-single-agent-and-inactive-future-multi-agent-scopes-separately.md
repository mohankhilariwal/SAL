# ADR-093: Model current single-agent and inactive future multi-agent scopes separately
...
## Decision
Assess the running one-agent architecture and a clearly labelled future MCP/A2A/multi-agent scope without allocating or activating another agent.
