...
## Decision
Threat reports and treatment recommendations have authority_effect none and cannot mutate DATA-106, approve/finalize, change routes, create agents or deploy controls automatically.
