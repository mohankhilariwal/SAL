# ADR-090: Use a hybrid threat-modelling method
...
## Decision
Use data-flow and trust-boundary analysis plus STRIDE for systematic coverage, then add OWASP agentic crosswalks, attack trees and misuse cases for agent-specific and adversarial paths.
