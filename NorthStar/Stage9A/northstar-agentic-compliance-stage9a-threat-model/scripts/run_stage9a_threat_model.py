...
if __name__ == '__main__':
    ...
    write_json(ROOT/'reports/stage9a-threat-model.json', report)
    print(f"THREAT MODEL COMPLETE: {report['counts']['threats']} threats; {report['counts']['attack_trees']} attack trees; {report['counts']['misuse_cases']} misuse cases")
