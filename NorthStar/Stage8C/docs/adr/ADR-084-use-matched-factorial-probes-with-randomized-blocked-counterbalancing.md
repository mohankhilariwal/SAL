# ADR-084: Use matched factorial probes with randomized blocked counterbalancing
...
## Decision
Change one observable factor at a time, preserve semantic content, block important slices and counterbalance order.
