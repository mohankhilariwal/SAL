# ADR-088: Keep the laboratory provider-neutral and replay-only
...
## Decision
Do not select or call a live judge, activate a route or claim fairness/reliability from synthetic fixtures.
